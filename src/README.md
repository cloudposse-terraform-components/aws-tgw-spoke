...
| <a name="provider_aws.tgw-hub"></a> [aws.tgw-hub](#provider\_aws.tgw-hub) | >= 4.1, < 6.0.0 |
...
| <a name="module_tgw_hub_routes"></a> [tgw\_hub\_routes](#module\_tgw\_hub\_routes) | cloudposse/transit-gateway/aws | 0.12.0 |
