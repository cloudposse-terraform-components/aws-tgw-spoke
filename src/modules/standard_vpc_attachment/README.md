...
| <a name="input_network_account_stage_name"></a> [network\_account\_stage\_name](#input\_network\_account\_stage\_name) | The name of the stage designated as the network hub | `string` | `"network"` | no |
...
| <a name="input_owning_account"></a> [owning\_account](#input\_owning\_account) | The name of the account that owns the VPC being attached | `string` | `null` | no |
...
| <a name="input_tgw_config"></a> [tgw\_config](#input\_tgw\_config) | Object to pass common data from root module to this submodule. See root module for details | <pre>object({<br/>    existing_transit_gateway_id             = string<br/>    existing_transit_gateway_route_table_id = string<br/>    vpcs                                    = any<br/>    eks                                     = any<br/>  })</pre> | n/a | yes |
| <a name="input_tgw_connector_config"></a> [tgw\_connector\_config](#input\_tgw\_connector\_config) | Map of output from all `tgw/cross-region-hub-connector` components. See root module for details | `map(any)` | `{}` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_tg_config"></a> [tg\_config](#output\_tg\_config) | Transit Gateway configuration formatted for handling |
